export const chapter2Data = {
  president: {
    ...
    whatsapp: "https://wa.me/918788740090"
  },
  coordinator: {
  ...
  teams: {
    technical: {
      ...
      members: [
        ...
        "Vaishnavi Vitthal Lonkar", "Srushti Prakashrao Chapke", 
    ...
    design: {
      leader: "Supriya Satish Shahane",
      icon: "🎨",
      members: [
        "Radhika Deshmukh", "Rohini Arjun Suryawanshi", "Pratiksha Manchakrao Pawar", 
        "Mansi Ambadas Dhale", "Gayatri Gawale", "Shaikh Musaddique", 
        "Tanvi Anil Pampatwar", "Jyoti Solanke", "Srushti Ingole"
      ]
    },
    eventManagement: {
