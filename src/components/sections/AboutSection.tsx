  ...
  return (
    <section id="about" className="section-spacing bg-transparent scroll-mt-28 md:scroll-mt-32">
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-12 mt-12">
          <motion.div 
            initial={{ opacity: 0, x: -20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="p-8 md:p-12 space-y-6 md:space-y-8 rounded-3xl border bg-slate-950/75 border-white/10 shadow-2xl relative overflow-hidden group"
          >
            ...
            <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-ndc-purple/10 flex items-center justify-center text-ndc-purple mb-6 md:mb-8 group-hover:scale-110 transition-transform shadow-inner">
              <Target size={28} className="md:w-8 md:h-8" />
            </div>
            <div className="space-y-3 md:space-y-4">
              <h3 className="text-xl md:text-2xl font-black text-white tracking-tight">Our Vision</h3>
              <p className="text-on-glass-muted text-sm md:text-lg leading-relaxed">
          ...
          >
            ...
            <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-ndc-blue/10 flex items-center justify-center text-ndc-blue mb-6 md:mb-8 group-hover:scale-110 transition-transform shadow-inner">
              <Rocket size={28} className="md:w-8 md:h-8" />
            </div>
            <div className="space-y-3 md:space-y-4">
              <h3 className="text-xl md:text-2xl font-black text-white tracking-tight">Our Mission</h3>
              <p className="text-on-glass-muted text-sm md:text-lg leading-relaxed">
        ...
        <div className="mt-20">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="p-8 md:p-16 rounded-[2rem] border border-white/10 bg-slate-950/80 shadow-2xl relative overflow-hidden group"
          >
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12 md:gap-20">
              <div className="flex-1 text-center lg:text-left space-y-8">
                <div className="space-y-4">
                  <h3 className="text-2xl md:text-4xl font-black text-white tracking-tight leading-tight">Proven <br className="hidden md:block" /> <span className="gradient-text">Track Record</span></h3>
                  <p className="text-lg md:text-xl text-on-glass-muted leading-relaxed max-w-2xl">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-4 md:gap-8">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 group/item">
                      ...
                      <span className="text-xs md:text-sm font-black text-gray-200 uppercase tracking-[0.18em] group-hover/item:text-white transition-colors">{item.label}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="flex-shrink-0 grid grid-cols-2 gap-4 md:gap-6 w-full lg:w-auto">
                <div className="bg-white/5 p-8 md:p-10 rounded-2xl border border-white/10 text-center hover:bg-ndc-purple/10 hover:border-ndc-purple/30 transition-colors duration-300 group/stat shadow-xl">
                  <div className="text-4xl md:text-5xl font-black text-ndc-purple mb-2 group-hover:scale-110 transition-transform">08+</div>
                  <div className="text-xs md:text-sm font-black text-gray-300 uppercase tracking-[0.25em] group-hover:text-gray-100 transition-colors">SIH Squads</div>
                </div>
                <div className="bg-white/5 p-8 md:p-10 rounded-2xl border border-white/10 text-center hover:bg-ndc-blue/10 hover:border-ndc-blue/30 transition-colors duration-300 group/stat shadow-xl">
                  <div className="text-4xl md:text-5xl font-black text-ndc-blue mb-2 group-hover:scale-110 transition-transform">4th</div>
                  <div className="text-xs md:text-sm font-black text-gray-300 uppercase tracking-[0.25em] group-hover:text-gray-100 transition-colors">Techfest Rank</div>
                </div>
              </div>
            </div>
          </motion.div>
