...
import { Linkedin, Github, Mail, Users, Star, Award, Shield, History, Crown, MessageCircle, ChevronRight, Zap } from "lucide-react";
  ...
  return (
    <section id="team" className="py-24 md:py-32 bg-transparent relative overflow-hidden scroll-mt-20">
      ...
      <div className="section-container relative z-10">
        ...
        <TeamChapterView data={activeData} isChapter2={!showChapter1} />
