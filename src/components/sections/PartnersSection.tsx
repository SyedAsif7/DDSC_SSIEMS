...
const PartnersSection = () => {
  ...
  return (
    <section id="partners" className="section-spacing bg-transparent scroll-mt-28 md:scroll-mt-32">
        ...
        <div className="max-w-4xl mx-auto mt-12 space-y-8">
          {partners.map((partner, index) => (
            <motion.div 
              ...
              viewport={{ once: true }}
              className="p-8 rounded-3xl border backdrop-blur-xl bg-slate-900/40 border-white/10 shadow-2xl hover:border-ndc-blue/40 transition-all duration-500 group"
            >
              <div className="flex flex-col md:flex-row gap-10 items-center md:items-start text-center md:text-left">
                ...
                <div className="flex-1 space-y-6">
                  <div>
                    <span className={`inline-block px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-[0.18em] bg-white/5 ${partner.labelColor} border border-white/5 mb-4`}>
                      {partner.label}
                    </span>
                  ...
                  <Button 
                    variant="outline" 
                    className="h-12 px-8 rounded-xl border-white/10 bg-white/5 hover:bg-white/10 text-white font-black uppercase tracking-widest text-xs transition-all"
