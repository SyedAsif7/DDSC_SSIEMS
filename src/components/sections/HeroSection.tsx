        ...
        <div className="relative rounded-2xl sm:rounded-3xl md:rounded-[2rem] border border-white/10 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] bg-gradient-to-br from-slate-950 via-slate-950 to-indigo-950/40 overflow-hidden">
          ...
          <div className="relative z-10 grid lg:grid-cols-12 gap-5 sm:gap-8 md:gap-10 p-2 min-[380px]:p-3 sm:p-8 md:p-12 lg:p-14 items-start">
            ...
            >
              ...
              <div className="hidden md:block order-2 md:order-1 space-y-3 sm:space-y-6 md:space-y-7">
                {/* H1 */}
              ...
              <div className="relative mx-auto w-full max-w-[310px] min-[380px]:max-w-[335px] min-[440px]:max-w-[360px] sm:max-w-md lg:max-w-none lg:sticky lg:top-24">
                ...
                <article className="relative rounded-2xl sm:rounded-[2rem] border border-white/10 bg-slate-950/80 backdrop-blur-xl p-2.5 min-[380px]:p-3 min-[440px]:p-4 sm:p-6 md:p-8 shadow-2xl overflow-hidden">
                  ...
                  <div className="relative z-10 space-y-2.5 min-[380px]:space-y-3 sm:space-y-5 md:space-y-7">
                    ...
                    <div className="pt-0.5 space-y-1.5 min-[380px]:space-y-2 sm:space-y-3">
                      <div className="h-1 sm:h-2 w-full rounded-full bg-white/5 overflow-hidden">
                        <div
                      ...
                      <div className="flex items-center justify-center text-[7.5px] min-[380px]:text-[8.5px] sm:text-[10px] font-black uppercase tracking-wider text-gray-400 text-center">
                      ...
                      <div className="grid grid-cols-3 gap-1 sm:gap-2 pt-1 border-t border-white/5">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center justify-center gap-0.5 sm:gap-1 px-1 sm:px-2.5 py-1 min-[380px]:py-1.5 sm:py-2 rounded-lg sm:rounded-xl bg-white/5 hover:bg-red-500/20 hover:border-red-500/40 border border-white/10 text-[8.5px] min-[380px]:text-[9.5px] sm:text-xs font-bold text-gray-200 transition-colors truncate"
                        >
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center justify-center gap-0.5 sm:gap-1 px-1 sm:px-2.5 py-1 min-[380px]:py-1.5 sm:py-2 rounded-xl bg-white/5 hover:bg-pink-500/20 hover:border-pink-500/40 border border-white/10 text-[8.5px] min-[380px]:text-[9.5px] sm:text-xs font-bold text-gray-200 transition-colors truncate"
                        >
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center justify-center gap-0.5 sm:gap-1 px-1 sm:px-2.5 py-1 min-[380px]:py-1.5 sm:py-2 rounded-xl bg-white/5 hover:bg-blue-500/20 hover:border-blue-500/40 border border-white/10 text-[8.5px] min-[380px]:text-[9.5px] sm:text-xs font-bold text-gray-200 transition-colors truncate"
                        >
