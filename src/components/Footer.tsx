        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2 space-y-8 animate-fade-in">
            ...
            <div className="flex space-x-6">
              <a href="https://www.instagram.com/ddsc_club/" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-pink-500/30 p-5 rounded-2xl transition-all duration-500 hover:scale-125 hover:rotate-12 group backdrop-blur-md border border-white/20 hover:border-pink-400/50">
